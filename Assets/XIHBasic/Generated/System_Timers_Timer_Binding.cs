...
{
    unsafe class System_Timers_Timer_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(System.Timers.Timer);
            args = new Type[]{};
        ...
        static StackObject* Stop_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.Timers.Timer instance_of_this_method = (System.Timers.Timer)typeof(System.Timers.Timer).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
