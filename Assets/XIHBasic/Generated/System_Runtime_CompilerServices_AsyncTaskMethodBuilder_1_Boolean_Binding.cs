...
namespace ILRuntime.Runtime.Generated
{
    unsafe class System_Runtime_CompilerServices_AsyncTaskMethodBuilder_1_Boolean_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            args = new Type[]{typeof(System.Runtime.CompilerServices.TaskAwaiter<System.Boolean>), typeof(XIHBasic.IAsyncStateMachineAdapter.Adapter)};
            if (genericMethods.TryGetValue("AwaitUnsafeOnCompleted", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(void), typeof(System.Runtime.CompilerServices.TaskAwaiter<System.Boolean>).MakeByRefType(), typeof(XIHBasic.IAsyncStateMachineAdapter.Adapter).MakeByRefType()))
                    {
                        method = m.MakeGenericMethod(args);
        ...
        static StackObject* Start_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ((System.Runtime.CompilerServices.AsyncTaskMethodBuilder<System.Boolean>)instance_of_this_method).Start<XIHBasic.IAsyncStateMachineAdapter.Adapter>(ref @stateMachine);
        ...
        static StackObject* AwaitUnsafeOnCompleted_7(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            instance_of_this_method.AwaitUnsafeOnCompleted<System.Runtime.CompilerServices.TaskAwaiter<System.Boolean>, XIHBasic.IAsyncStateMachineAdapter.Adapter>(ref @awaiter, ref @stateMachine);
