...
public class TextureTools
{
    ...
    public static TextureImporterPlatformSettings GetPlatformWebGLSettings(TextureImporter importer)
    {
        TextureImporterPlatformSettings platformSetting = importer.GetPlatformTextureSettings("WebGL");
        return platformSetting;
    }
    ...
    public static TextureImporterFormat GetPlatformWebGLFormat(TextureImporter importer)
    {
        TextureImporterPlatformSettings platformSetting = GetPlatformWebGLSettings(importer);
        var format = platformSetting.format;
        if (format.ToString().StartsWith("Automatic"))
            format = importer.GetAutomaticFormat("WebGL");
        return format;
    }
}
