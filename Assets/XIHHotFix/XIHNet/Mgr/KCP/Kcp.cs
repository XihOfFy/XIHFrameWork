...
namespace XiHNet
{
    ...
    {   /*
        ...
        */
        ...
        public delegate void OutputDelegate(byte[] data, int size);
        OutputDelegate _output;
        // create a new kcp control object, 'conv'(频道号) must equal in two endpoint
        // from the same connection. 'user' will be passed to the output callback
        // output callback can be setup like this: 'kcp->output = my_udp_output'
        public Kcp(UInt32 conv, OutputDelegate output)
        {
