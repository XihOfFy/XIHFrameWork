...
namespace Hot
{
class DYTouchInputOverride : StarkSDKSpace.StarkInputOverrideBypass {
}
// #if UNITY_TT
// class DYTouchInputOverride : TTSDK.TTInputOverrideBypass
// {
// }
// #endif
...
public class DYStarkSDK : IChannelSDK
{
    ...
    public void TouchOverride(GameObject dotDestoryObj)
    {
        ...
        gameObject.AddComponent<DYTouchInputOverride>();//抽象
